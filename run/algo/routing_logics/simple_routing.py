...
def route_flows_one_by_one(all_flows, rem, usage, num_spines, 
    ...
    for flow in all_flows:
        ...
        selected_spines = route_one_flow(flow, run_context["routing-fit-strategy"], 
...
def route_one_flow(flow, selection_strategy, spine_availablity, max_subflow_count, num_spines): 
    selected_spines = []    
