...
def main():
    ...
    placement_modes = ["sim_firstfit", "compact", "random"] #["random", "semirandom_4", "semirandom_2", "compact"]
    ...
    for lb in ["xxx"]:
        ...
        exp_sweep_config = {
            ...
            "lb-scheme": ["ecmp", "random", "perfect"],
            "timing-scheme": ["cassini"],
            "ring-mode": ["optimal"],
            "ecmp-entropy-options": [1, 2, 4, 8],
        ...
        exp_context = {
            ...
            "comparison-base": {"ring-mode": "optimal", 
                                "lb-scheme": "ecmp",
                                "ecmp-entropy-options": 1,  
                                "timing-scheme": "cassini"},  
            
            "comparisons": [
                ("QP2", {"ecmp-entropy-options": 2}),
                ("QP4", {"ecmp-entropy-options": 4}),
                ("QP8", {"ecmp-entropy-options": 8}),
                
                ("random", {"lb-scheme": "random"}),
                ("perfect", {"lb-scheme": "perfect"}),    
            ]
        } 
