...
sweep_config = {
    ...
    "general-param-1": range(0, 300, 1),
    "general-param-2": [50], #range(10, 51, 10), 
}
...
base_options = {
    ...
    "general-param-1": -1,  # job 2 initial shift
    "general-param-2": -1, # comm duty cycle for job 1 
    "general-param-7": -1, # comm duty cycle for job 2
    "general-param-3": 200, # number of reps 
    "general-param-4": 4, # number of teeth
    "general-param-8": 4, # number of teeth
