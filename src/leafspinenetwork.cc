...
int LeafSpineNetwork::select_core(Flow* flow, double timer, core_selection mechanism) {
    ...
    ///////////////////////////////////////////////////////////////////
        ...
        if (GContext::is_first_run()) {
            ...
            auto this_run_bn_up = tor_core_bottlenecks[ft_loc{-1, src_rack, -1, 1, best_core}];
            auto this_run_bn_down = tor_core_bottlenecks[ft_loc{-1, dst_rack, -1, 2, best_core}];
